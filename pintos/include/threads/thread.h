...
#define FDT_DEFAULT 3
#define FDCOUNT_LIMIT (FDT_DEFAULT) * (1 << 9)
...
struct thread {
	...
	// struct intr_frame fork_tf; 수정된 곳 만들어놓고 쓰지도 않노 이놈은
...
extern bool priority_first (const struct list_elem *a_, const struct list_elem *b_, void *aux UNUSED);
